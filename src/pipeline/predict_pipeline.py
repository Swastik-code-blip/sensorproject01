...
class PredictionPipelineConfig:
    ...
    model_file_path:str=os.path.join(artifact_folder,'model.plk')
    preprocessor_path:str=os.path.join(artifact_folder,'preprocessor.plk')
...
class PredictionPipeline:
    ...
    def predict(self,features):
        ...
        try:
            ...
            preprocessor=self.utils.load_object(file_path=self.predictions_pipeline_config.preprocessor_path)
